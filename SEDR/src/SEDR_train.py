...
class SEDR_Train:
    ...
    def train_without_dec(self, return_loss=False):
        self.model.train()
    ...
    def train_with_dec(self, return_loss=False):
        ...
        for epoch_id in range(self.epochs):
            ...
            losses[0].append(self.params.gcn_w * loss_gcn.item())
            losses[1].append(self.params.dec_kl_w * loss_kl.item())
            losses[2].append(self.params.feat_w * loss_rec.item())
            loss.backward()
            self.optimizer.step()
