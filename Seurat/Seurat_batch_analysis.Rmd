...
data1.3 <- as.sparse(read.csv("prostate-twelve/P1.3.tsv", sep='\t'))
...
colnames(data1.3) = paste0("1.3", colnames(data1.3))
...
seurat.data1.3 <- CreateSeuratObject(counts = data1.3, project = "Prostate1.3", min.cells = 2, min.features = 200)
...
d.list = c(seurat.data1.2, seurat.data1.3, seurat.data2.4, seurat.data3.3)
